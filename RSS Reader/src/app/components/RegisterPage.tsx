...
export function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0a1a12]">
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        ...
        >
          <h2 className="text-lg font-semibold text-white mb-2">Регистрация</h2>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg py-2.5 text-sm font-semibold text-white bg-emerald-600 hover:bg-emerald-500 transition-colors disabled:opacity-50 mt-2"
          >
