    ...
    <div className="relative group/summarize flex-shrink-0">
      ...
      >
        {isLoading
          ...
          : <Lightbulb className={`${iconClass} ${isActive ? "fill-current" : ""}`} />
        }
      </button>

      {/* Tooltip */}
      <div className="pointer-events-none absolute bottom-full right-0 mb-1.5 hidden group-hover/summarize:block z-50">
